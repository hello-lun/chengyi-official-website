...
const footer_content = {
  footer_info: [
    ...
    },
    {
      ...
      cls: "footer-col-3",
      links: [
        { name: "佛山市顺德区北滘镇慧聪家电城2座410(成益自动化)" },
        { name: "+86 13610307032" },
        { name: "+86 13725293855" },
        { name: "alissa@chengyiauto.cn" },
        { name: "anna@chengyiauto.cn" },
        { name: "Office Hours: 8AM - 11PM" },
        { name: "Open Monday - Saturday" },
      ],
    },
  ],
  contact_info: [
            ...
            <div className="row">
              <div className="col-xl-3 col-lg-4 col-md-6">
                ...
                >
                  ...
                  <p>
                  CHENGYI is a premier supplier in China specializing in PLC, CPU, HMI, touch screen, inverter, frequency converter, servo motor + drive + encoder, circuit breaker, contactor, relay, sensor, limit switch, and pneumatic components products. Discover our high-quality industrial automation solutions today.
                  </p>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6">
                ...
                >
                  ...
                  <p>Email us immediately</p>
                  <Button className={styles.sendMessage} icon={<SendOutlined/>} onClick={sendEmail}><span style={{verticalAlign: 'text-top'}}>Send Message</span></Button>
                </div>
              </div>
            </div>
          </div>
